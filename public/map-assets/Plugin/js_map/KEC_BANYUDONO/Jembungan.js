const subsidiJembunganLayer = L.featureGroup();
const nonsubsidiJembunganLayer = L.featureGroup();
...
const DesaJembungan = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiJembunganLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiJembunganLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Jembungan.geojson", function (data) {

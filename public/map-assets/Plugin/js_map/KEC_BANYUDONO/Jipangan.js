const subsidiJipanganLayer = L.featureGroup();
const nonsubsidiJipanganLayer = L.featureGroup();
...
const DesaJipangan = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiJipanganLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiJipanganLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Jipangan.geojson", function (data) {

const subsidiTanjungsariLayer = L.featureGroup();
const nonsubsidiTanjungsariLayer = L.featureGroup();
...
const DesaTanjungsari = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiTanjungsariLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiTanjungsariLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Tanjungsari.geojson", function (data) {

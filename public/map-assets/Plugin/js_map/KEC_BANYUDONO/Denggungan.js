const subsidiDenggunganLayer = L.featureGroup();
const nonsubsidiDenggunganLayer = L.featureGroup();
...
const DesaDenggungan = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiDenggunganLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiDenggunganLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Denggungan.geojson", function (data) {

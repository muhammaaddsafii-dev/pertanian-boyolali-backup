const subsidiDukuhLayer = L.featureGroup();
const nonsubsidiDukuhLayer = L.featureGroup();
...
const DesaDukuh = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiDukuhLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiDukuhLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Dukuh.geojson", function (data) {

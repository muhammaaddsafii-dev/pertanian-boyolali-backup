const subsidiTrayuLayer = L.featureGroup();
const nonsubsidiTrayuLayer = L.featureGroup();
...
const DesaTrayu = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiTrayuLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiTrayuLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Trayu.geojson", function (data) {

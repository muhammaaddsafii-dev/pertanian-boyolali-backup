const subsidiBatanLayer = L.featureGroup();
const nonsubsidiBatanLayer = L.featureGroup();
...
const DesaBatan = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiBatanLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiBatanLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Batan.geojson", function (data) {

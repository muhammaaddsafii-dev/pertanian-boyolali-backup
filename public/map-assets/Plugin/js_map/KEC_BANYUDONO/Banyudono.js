const subsidiBanyudonoLayer = L.featureGroup();
const nonsubsidiBanyudonoLayer = L.featureGroup();
...
const DesaBanyudono = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiBanyudonoLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiBanyudonoLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Banyudono.geojson", function (data) {

const subsidiCangkringanLayer = L.featureGroup();
const nonsubsidiCangkringanLayer = L.featureGroup();
...
const DesaCangkringan = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiCangkringanLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiCangkringanLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Cangkringan.geojson", function (data) {

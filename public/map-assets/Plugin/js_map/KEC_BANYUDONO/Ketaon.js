const subsidiKetaonLayer = L.featureGroup();
const nonsubsidiKetaonLayer = L.featureGroup();
...
const DesaKetaon = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiKetaonLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiKetaonLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Ketaon.geojson", function (data) {

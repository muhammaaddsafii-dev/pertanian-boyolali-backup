const subsidiNgaruaruLayer = L.featureGroup();
const nonsubsidiNgaruaruLayer = L.featureGroup();
...
const DesaNgaruaru = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiNgaruaruLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiNgaruaruLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Ngaruaru.geojson", function (data) {

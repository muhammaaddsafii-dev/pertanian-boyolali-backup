const subsidiSambonLayer = L.featureGroup();
const nonsubsidiSambonLayer = L.featureGroup();
...
const DesaSambon = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    ...
    if (feature.properties.SB_PPK === "SUBSIDI") {
      subsidiSambonLayer.addLayer(layer);
    } else if (feature.properties.SB_PPK === "NON_SUBSIDI") {
      nonsubsidiSambonLayer.addLayer(layer);
    }
  },
});
...
$.getJSON("/Data/KEC_BANYUDONO/Sambon.geojson", function (data) {

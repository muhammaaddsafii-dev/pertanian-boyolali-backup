...
class ImportCangkringanFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-cangkringan';
    protected $description = 'Import CANGKRINGAN data from CANGKRINGAN.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/CANGKRINGAN.geojson';

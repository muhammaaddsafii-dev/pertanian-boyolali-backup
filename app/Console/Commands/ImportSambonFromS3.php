...
class ImportSambonFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-sambon';
    protected $description = 'Import SAMBON data from SAMBON.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/SAMBON.geojson';

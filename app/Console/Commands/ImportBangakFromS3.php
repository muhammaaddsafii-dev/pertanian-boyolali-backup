...
class ImportBangakFromS3 extends Command
{
    /**
    ...
    protected $signature = 'import-bangak';
    protected $description = 'Import BANGAK data from BANGAK.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/BANGAK.geojson';

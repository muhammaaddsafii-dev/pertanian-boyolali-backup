...
class ImportTrayuFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-trayu';
    protected $description = 'Import TRAYU data from TRAYU.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/TRAYU.geojson';

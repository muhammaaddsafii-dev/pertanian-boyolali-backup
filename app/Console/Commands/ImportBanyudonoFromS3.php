...
class ImportBanyudonoFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-banyudono';
    protected $description = 'Import BANYUDONO data from BANYUDONO.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/BANYUDONO.geojson';

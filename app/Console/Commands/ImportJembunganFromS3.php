...
class ImportJembunganFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-jembungan';
    protected $description = 'Import JEMBUNGAN data from JEMBUNGAN.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/JEMBUNGAN.geojson';

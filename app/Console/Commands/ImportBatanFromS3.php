...
class ImportBatanFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-batan';
    protected $description = 'Import BATAN data from BATAN.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/BATAN.geojson';

...
class ImportDukuhFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-dukuh';
    protected $description = 'Import DUKUH data from DUKUH.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/DUKUH.geojson';

...
class ImportKuwranFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-kuwran';
    protected $description = 'Import KUWRAN data from KUWRAN.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/KUWRAN.geojson';

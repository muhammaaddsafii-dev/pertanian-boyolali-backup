...
class ImportTanjungSariFromS3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import-tanjungsari';
    protected $description = 'Import TANJUNGSARI data from TANJUNGSARI.geojson';
    ...
    {
        $path = 'pertanian-boyolali/geojson-files/TANJUNGSARI.geojson';

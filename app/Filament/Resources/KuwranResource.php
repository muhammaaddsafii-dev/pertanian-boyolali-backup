...
use App\Filament\Resources\KuwranResource\Pages;
use App\Filament\Resources\KuwranResource\RelationManagers;
use App\Models\Kuwran;
use Filament\Forms;
...
class KuwranResource extends Resource
{
    protected static ?string $model = Kuwran::class;

    protected static ?string $navigationIcon = 'heroicon-o-user-group';

    protected static ?string $navigationLabel = 'Kuwran';
    ...
    {
        return [
            'index' => Pages\ListKuwrans::route('/'),
            'create' => Pages\CreateKuwran::route('/create'),
            'edit' => Pages\EditKuwran::route('/{record}/edit'),
        ];
    }

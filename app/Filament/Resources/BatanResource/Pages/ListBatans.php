...
class ListBatans extends ListRecords
{
    ...
    {
        return Excel::download(new BatanExport, 'batan.xlsx');
    }

    public function downloadGeojson()
    {
        // S3 object key (path to the file in the bucket)
        $filePath = 'pertanian-boyolali/geojson-files/BATAN.geojson';

        // The filename to be used for the downloaded file
        $fileName = 'BATAN.geojson';

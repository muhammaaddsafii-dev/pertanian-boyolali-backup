...
use App\Filament\Resources\BangakResource\Pages;
use App\Filament\Resources\BangakResource\RelationManagers;
use App\Models\Bangak;
use Filament\Forms;
...
class BangakResource extends Resource
{
    protected static ?string $model = Bangak::class;

    protected static ?string $navigationIcon = 'heroicon-o-user-group';

    protected static ?string $navigationLabel = 'Bangak';
    ...
    {
        return [
            'index' => Pages\ListBangaks::route('/'),
            'create' => Pages\CreateBangak::route('/create'),
            'edit' => Pages\EditBangak::route('/{record}/edit'),
        ];
    }

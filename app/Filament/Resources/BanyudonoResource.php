...
use App\Filament\Resources\BanyudonoResource\Pages;
use App\Filament\Resources\BanyudonoResource\RelationManagers;
use App\Models\Banyudono;
use Filament\Forms;
...
class BanyudonoResource extends Resource
{
    protected static ?string $model = Banyudono::class;

    protected static ?string $navigationIcon = 'heroicon-o-user-group';

    protected static ?string $navigationLabel = 'Banyudono';
    ...
    {
        return [
            'index' => Pages\ListBanyudonos::route('/'),
            'create' => Pages\CreateBanyudono::route('/create'),
            'edit' => Pages\EditBanyudono::route('/{record}/edit'),
        ];
    }

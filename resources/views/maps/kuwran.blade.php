...
<body>
    ...
    <script>
        ...
        title.onAdd = function() {
            ...
            this._div.innerHTML =
                "<h4>PETA SEBARAN SUBSIDI PUPUK PERTANIAN DESA KUWRAN</h4>DIBUAT: GEOCIRCLE INDONESIA";
            return this._div;
        };
        title.addTo(map);
        ...
        const zoomBar = L.easyBar([
            ...
            L.easyButton("fa-home fa-lg", function(control, map) {
                map.fitBounds(DesaKuwran.getBounds());
            }),
            L.easyButton("<big>-</big>", function(control, map) {
                map.setZoom(map.getZoom() - 1);
            }),
        ...
        map.createPane("pane_DesaKuwran");
        Object.assign(map.getPane("pane_DesaKuwran").style, {
            zIndex: 405,
            mixBlendMode: "normal",
        });
        ...
        const DesaKuwran = L.geoJson(null, {
            style: function(feature) {
                const baseStyle = {
                    pane: "pane_DesaKuwran",
                    opacity: 1,
                    weight: 1,
                    fillOpacity: 0.6,
                    fill: true,
        ...
        $.getJSON(
            "https://cdn-project-desa.s3.ap-southeast-1.amazonaws.com/pertanian-boyolali/geojson-files/KUWRAN.geojson",
            function(data) {
                DesaKuwran.addData(data);
            }
        );
        ...
        function createSearchControl(propertyName, placeholder) {
            const searchControl = new L.Control.Search({
                ...
                moveToLocation: function(latlng, title) {
                    ...
                    DesaKuwran.eachLayer(function(layer) {
                        if (
                            layer.feature &&
            ...
            searchControl
                ...
                .on("search:collapsed", function() {
                    DesaKuwran.eachLayer(DesaKuwran.resetStyle);
                });

...
<body>
    ...
    <script>
        ...
        title.onAdd = function() {
            ...
            this._div.innerHTML =
                "<h4>PETA SEBARAN SUBSIDI PUPUK PERTANIAN DESA CANGKRINGAN</h4>DIBUAT: GEOCIRCLE INDONESIA";
            return this._div;
        };
        title.addTo(map);
        ...
        const zoomBar = L.easyBar([
            ...
            L.easyButton("fa-home fa-lg", function(control, map) {
                map.fitBounds(DesaCangkringan.getBounds());
            }),
            L.easyButton("<big>-</big>", function(control, map) {
                map.setZoom(map.getZoom() - 1);
            }),
        ...
        map.createPane("pane_DesaCangkringan");
        Object.assign(map.getPane("pane_DesaCangkringan").style, {
            zIndex: 405,
            mixBlendMode: "normal",
        });
        ...
        const DesaCangkringan = L.geoJson(null, {
            style: function(feature) {
                const baseStyle = {
                    pane: "pane_DesaCangkringan",
                    opacity: 1,
                    weight: 1,
                    fillOpacity: 0.6,
                    fill: true,
            ...
            onEachFeature: function(feature, layer) {
                ...
                layer.on({
                    ...
                    mouseout: function() {
                        DesaCangkringan.resetStyle(layer);
                    },
                });
        ...
        $.getJSON(
            "https://cdn-project-desa.s3.ap-southeast-1.amazonaws.com/pertanian-boyolali/geojson-files/CANGKRINGAN.geojson",
            function(data) {
                DesaCangkringan.addData(data);
            }
        );
        ...
        function createSearchControl(propertyName, placeholder) {
            const searchControl = new L.Control.Search({
                ...
                layer: DesaCangkringan,
                propertyName,
                marker: false,
                collapsed: false,
                moveToLocation: function(latlng, title) {
                    const matchingFeatures = [];
                    DesaCangkringan.eachLayer(function(layer) {
                        if (
                            layer.feature &&
            ...
            searchControl
                ...
                .on("search:collapsed", function() {
                    DesaCangkringan.eachLayer(DesaCangkringan.resetStyle);
                });

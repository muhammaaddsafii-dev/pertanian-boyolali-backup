...
<body>
    ...
    <script>
        ...
        title.onAdd = function() {
            ...
            this._div.innerHTML =
                "<h4>PETA SEBARAN SUBSIDI PUPUK PERTANIAN DESA JEMBUNGAN</h4>DIBUAT: GEOCIRCLE INDONESIA";
            return this._div;
        };
        title.addTo(map);
        ...
        const zoomBar = L.easyBar([
            ...
            L.easyButton("fa-home fa-lg", function(control, map) {
                map.fitBounds(DesaJembungan.getBounds());
            }),
            L.easyButton("<big>-</big>", function(control, map) {
                map.setZoom(map.getZoom() - 1);
            }),
        ...
        map.createPane("pane_DesaJembungan");
        Object.assign(map.getPane("pane_DesaJembungan").style, {
            zIndex: 405,
            mixBlendMode: "normal",
        });
        ...
        const DesaJembungan = L.geoJson(null, {
            style: function(feature) {
                const baseStyle = {
                    pane: "pane_DesaJembungan",
                    opacity: 1,
                    weight: 1,
                    fillOpacity: 0.6,
                    fill: true,
            ...
            onEachFeature: function(feature, layer) {
                ...
                layer.on({
                    ...
                    mouseout: function() {
                        DesaJembungan.resetStyle(layer);
                    },
                });
        ...
        $.getJSON(
            "https://cdn-project-desa.s3.ap-southeast-1.amazonaws.com/pertanian-boyolali/geojson-files/JEMBUNGAN.geojson",
            function(data) {
                DesaJembungan.addData(data);
            }
        );
        ...
        function createSearchControl(propertyName, placeholder) {
            const searchControl = new L.Control.Search({
                ...
                moveToLocation: function(latlng, title) {
                    ...
                    DesaJembungan.eachLayer(function(layer) {
                        if (
                            layer.feature &&
            ...
            searchControl
                ...
                .on("search:collapsed", function() {
                    DesaJembungan.eachLayer(DesaJembungan.resetStyle);
                });

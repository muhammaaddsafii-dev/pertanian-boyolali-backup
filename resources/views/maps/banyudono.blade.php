...
<body>
    ...
    <script>
        ...
        title.onAdd = function() {
            ...
            this._div.innerHTML =
                "<h4>PETA SEBARAN SUBSIDI PUPUK PERTANIAN DESA BANYUDONO</h4>DIBUAT: GEOCIRCLE INDONESIA";
            return this._div;
        };
        title.addTo(map);
        ...
        const zoomBar = L.easyBar([
            ...
            L.easyButton("fa-home fa-lg", function(control, map) {
                map.fitBounds(DesaBanyudono.getBounds());
            }),
            L.easyButton("<big>-</big>", function(control, map) {
                map.setZoom(map.getZoom() - 1);
            }),
        ...
        map.createPane("pane_DesaBanyudono");
        Object.assign(map.getPane("pane_DesaBanyudono").style, {
            zIndex: 405,
            mixBlendMode: "normal",
        });
        ...
        const DesaBanyudono = L.geoJson(null, {
            style: function(feature) {
                const baseStyle = {
                    pane: "pane_DesaBanyudono",
                    opacity: 1,
                    weight: 1,
                    fillOpacity: 0.6,
                    fill: true,
            ...
            onEachFeature: function(feature, layer) {
                ...
                layer.on({
                    ...
                    mouseout: function() {
                        DesaBanyudono.resetStyle(layer);
                    },
                });
        ...
        $.getJSON(
            "https://cdn-project-desa.s3.ap-southeast-1.amazonaws.com/pertanian-boyolali/geojson-files/BANYUDONO.geojson",
            function(data) {
                DesaBanyudono.addData(data);
            }
        );
        ...
        function createSearchControl(propertyName, placeholder) {
            const searchControl = new L.Control.Search({
                ...
                moveToLocation: function(latlng, title) {
                    ...
                    DesaBanyudono.eachLayer(function(layer) {
                        if (
                            layer.feature &&
            ...
            searchControl
                ...
                .on("search:collapsed", function() {
                    DesaBanyudono.eachLayer(DesaBanyudono.resetStyle);
                });
